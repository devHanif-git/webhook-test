...
const secret =
  "eAoho9vqPDG5rsHDYN5skfqzZvINvOsbB3xCOf2up7CSGtgGw7Q38XYfsdl9oewac3QHhxkkR/ncKwNHmSQ5Wg=="; // Replace with your actual secret key
...
app.post("/webhook", (req, res) => {
  ...
  console.log(
    "Length of computed hash buffer:",
    Buffer.from(signature, "hex").length
  );
  console.log(
    "Length of header signature buffer:",
    Buffer.from(headerSignature, "hex").length
  );
